...
namespace ComplexityWebApi.DTO
{
    public class DataBaseTemplateGeneratorWithStreakDTO
    {
        ...
        public DataBaseTemplateGeneratorWithStreakDTO(string template, IEnumerable<string> possibleAnswers, string rightAnswer, IEnumerable<string> hints, int streak)
        {
            Template = template;
