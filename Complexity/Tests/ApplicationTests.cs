...
namespace Tests
{
    ...
    public class ApplicationTests
    {
        ...
        private Guid AddEmptyLevel(Guid topicId) =>
            taskRepository.InsertLevel(topicId, CreateLevel())
                          .Id;

        private static Level
            CreateLevel(Guid id, IEnumerable<TaskGenerator> generators, IEnumerable<Guid> nextLevels) =>
        ...
        {
            application.GetAvailableLevels(Guid.NewGuid(), Guid.NewGuid())
                       .IsFailure.Should()
                       .BeTrue();
        }
        ...
        public void GetAvailableLevels_ReturnsFirstLevel_WhenNoProgress()
        {
            ...
            application.GetAvailableLevels(Guid.NewGuid(), topicId)
                       .Value.First()
                       .Id.Should()
                       .Be(ids.First());
        }
        ...
        public void GetAvailableLevels_ReturnsSuccess_WhenNoLevels()
        {
            ...
            application.GetAvailableLevels(Guid.NewGuid(), id)
                       .IsSuccess.Should()
                       .BeTrue();
        }
        ...
        {
            var id = AddEmptyTopic();
            application.GetCurrentProgress(Guid.NewGuid(), id, Guid.NewGuid())
                       .IsFailure.Should()
                       .BeTrue();
        }
        ...
        {
            application.GetCurrentProgress(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid())
                       .IsFailure.Should()
                       .BeTrue();
        }
        ...
        public void GetCurrentProgress_ReturnsSuccess_WhenNoUsers()
        {
            ...
            application.GetCurrentProgress(Guid.NewGuid(), topicId, levelId)
                       .IsSuccess.Should()
                       .BeTrue();
        }
        ...
        {
            application.GetLevels(Guid.NewGuid())
                       .IsFailure.Should()
                       .BeTrue();
        }
        ...
        public void GetTask_ReturnsFailure_WhenLevelNotAvailable()
        {
            ...
            application.GetTask(user.Id, topicId, levelId)
                       .IsFailure.Should()
                       .BeTrue();
        }
        ...
        {
            var id = AddEmptyTopic();
            application.GetTask(Guid.NewGuid(), id, Guid.NewGuid())
                       .IsFailure.Should()
                       .BeTrue();
        }
        ...
        {
            var (topicId, levelId) = AddTopicWithLevel();
            application.GetTask(Guid.NewGuid(), topicId, levelId)
                       .IsSuccess.Should()
                       .BeTrue();
        }
