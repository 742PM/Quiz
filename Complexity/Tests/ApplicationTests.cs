...
namespace Tests
{
    ...
    public class ApplicationTests
    {
        ...
        {
            Action action = () => applicationWithoutTopics.GetAvailableDifficulties(Guid.NewGuid(), Guid.NewGuid());
            action.Should().Throw<ArgumentException>();
        }
        ...
        {
            Action action = () => application.GetAvailableDifficulties(Guid.NewGuid(), Guid.NewGuid());
            action.Should().Throw<ArgumentException>();
        }
        ...
        {
            var id = applicationWithoutGenerators.GetTopicsInfo().First().Id;
            applicationWithoutGenerators.GetAvailableDifficulties(Guid.NewGuid(), id).Should().BeEmpty();
        }
        ...
        public void GetAvailableDifficulties_ReturnsOne_WhenUserIsNew()
        {
            ...
            application.GetAvailableDifficulties(Guid.NewGuid(), id).Count().Should().Be(1);
        }
        ...
        {
            var id = application.GetTopicsInfo().First().Id;
            var minDifficulty = application.GetDifficulties(id).Min();
            application.GetAvailableDifficulties(Guid.NewGuid(), id).First().Should().Be(minDifficulty);
        }
        ...
        public void GetAvailableDifficulties_ReturnsOne_WhenTopicIsNew()
        {
            ...
            application.GetAvailableDifficulties(userId, topicId).Count().Should().Be(1);
        }
        ...
        public void GetAvailableDifficulties_ReturnsMin_WhenTopicIsNew()
        {
            ...
            var minDifficulty = application.GetDifficulties(topicId).Min();
            application.GetAvailableDifficulties(userId, topicId).Last().Should().Be(minDifficulty);
        }
        ...
        public void GetAvailableDifficulties_ReturnsAllStarted_WhenSomeDifficultiesAreStarted()
        {
            ...
            application.GetAvailableDifficulties(userId, topicId).Count().Should().Be(2);
        }
        ...
        {
            var topicId = application.GetTopicsInfo().Skip(2).First().Id;
            application.GetAvailableDifficulties(userId, topicId).Last().Should().Be(2);
        }
        ...
        public void GetAvailableDifficulties_ReturnsNew_WhenDifficultyIsFinished()
        {
            ...
            application.GetAvailableDifficulties(userId, topicId).Last().Should().Be(3);
        }
